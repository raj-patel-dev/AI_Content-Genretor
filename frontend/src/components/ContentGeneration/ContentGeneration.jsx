...
const formik = useFormik({
        ...
        validationSchema:Yup.object({
            ...
            tone:Yup.string().required("Slecting a tone is required"),
            category:Yup.string().required("Selecring a category is reqired")
        }),
         onSubmit: (values) => {
        mutation.mutate(
            `Generate a blog post about "${values.prompt}" in the ${values.category} category with a ${values.tone} tone.`
        );
    }
});
